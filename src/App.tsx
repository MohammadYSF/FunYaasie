  ...
  const [data, setData] = useState([
    {
      ...
      "subject": "سرویس",
      "description": "کلمه ای است با معانی مختلف.مثلا :  میرم سرویس . دهنت سرویس . سرویس اینو بنویس . به این سرویس بده . سرویس تعریف کن "
    },
    {
      "id": 2,
      "reporter": "محمد یوسفیان",
      "subject": "کامل",
      "description": "کلمه ای است عربی که در زبان فارسی استفاده می شود و می توان گفت در استفاده امروزی زبان جانشین ناپذیر است"
    },
    {
      "id": 3,
      "reporter": "محمد یوسفیان",
      "subject": "ممیزی و ممیز",
      "description": "ممیز کسی است که ممیزی می کند . به همی راحتی"
    }
  ] as funInfo[]);
